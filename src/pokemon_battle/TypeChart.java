...
public class TypeChart {
	...
	public static double getMultiplier(PokemonType attackType, PokemonType pokemonAttakedType) {
		return TypeChart.MULTIPLIERS[attackType.ordinal()][pokemonAttakedType.ordinal()];
	}
}
